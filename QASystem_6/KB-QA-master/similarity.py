...
def generate_dic_and_corpus(knowledge_file, file_name, stop_words):
    ...
    dictionary.save(os.path.join(r"C:\\Users\\chenn\\experiment\\deepshare\\NLP\\1word2vecfasttext\\code6\\KB-QA-master\\tmp\\dictionary.dict"))

    corpus = [dictionary.doc2bow(text) for text in knowledge_texts]  # corpus of knowledge
    corpora.MmCorpus.serialize(r'C:\\Users\\chenn\\experiment\\deepshare\\NLP\\1word2vecfasttext\\code6\\KB-QA-master\\tmp\\knowledge_corpus.mm', corpus)


def topk_sim_ix(file_name, stop_words, k):
    sim_path = r"C:\\Users\\chenn\\experiment\\deepshare\\NLP\\1word2vecfasttext\\code6\\KB-QA-master\\tmp\\"
    sim_path += file_name[5:-4]
    ...
    dictionary = corpora.Dictionary.load(r"C:\\Users\\chenn\\experiment\\deepshare\\NLP\\1word2vecfasttext\\code6\\KB-QA-master\\tmp\\dictionary.dict")  # dictionary of knowledge and train data
    corpus = corpora.MmCorpus(r"C:\\Users\\chenn\\experiment\\deepshare\\NLP\\1word2vecfasttext\\code6\\KB-QA-master\\tmp\\knowledge_corpus.mm")  # corpus of knowledge
    ...
    with open(file_name) as f:
        ...
        for i, line in enumerate(f):
            ...
            if i % 6 == 1:
                ...
                tmp.clear()
    with open(sim_path, "wb",encoding='utf-8') as f:
